...
public class BufferReadAFile {
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			String content = new Scanner(new File("/Users/apple/Coding/Java_Tea/ReadingNotes/Java/Fundmental/BufferReader_vs_Scanner/Instance1.shit.java")).useDelimiter("\\Z").next();
			content.raplaceAll("　","");
			//System.out.println(content);
			searchSubString(content.toCharArray(),"水电费".toCharArray());
